...
h = legend([p1 p3 p4 p5], {'Target', 'Koopman-based MPC', 'Proposed', 'Proposed under data noise'}, 'FontName', 'Times New Roman', 'Fontsize', 8);
set(h, ...
...
annotation('line', [0.174946568627451 0.216219117647059], [0.981498015873017, 0.981498015873017], 'LineWidth',1,'Color', [0.1, 0.1, 0.1])
