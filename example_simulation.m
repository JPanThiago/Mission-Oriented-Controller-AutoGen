%------------------------------------------------------------------%
%--- The simulation results of path tracking for various robots ---%
%------------------------------------------------------------------%
close all;
clear;
...
[DP, DP_loss_avg, DP_loss_avg_un, DP_loss_avg_noise] = control_DP();
[TDVPT, TDVPT_loss_avg, TDVPT_loss_avg_un, TDVPT_loss_avg_noise] = control_TDVPT(3);
[softrobot, softrobot_loss_avg, softrobot_loss_avg_un, softrobot_loss_avg_noise] = control_SoftRobot();
[AUV, AUV_loss_avg, AUV_loss_avg_un, AUV_loss_avg_noise] = control_AUV();
...
hold on
p3 = plot(DP.t1.X_un(:, 2) * 180 / pi, DP.t1.X_un(:, 1) * 180 / pi, '-', 'LineWidth', 1, 'MarkerSize', 4, 'Color', [0.3, 0.75, 0.7]);
hold on
